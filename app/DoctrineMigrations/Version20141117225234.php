...
class Version20141117225234 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE subscription ADD CONSTRAINT FK_763C46B4B2685369 FOREIGN KEY (corporation_id) REFERENCES corporation (id)');
        $this->addSql('ALTER TABLE subscription ADD CONSTRAINT FK_763C46B47597D3FE FOREIGN KEY (member_id) REFERENCES member (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE subscription DROP FOREIGN KEY FK_763C46B4B2685369');
        $this->addSql('ALTER TABLE subscription DROP FOREIGN KEY FK_763C46B47597D3FE');
